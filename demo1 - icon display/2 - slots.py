# Example displaying an three images tiled across the screen.
# The rows will spin like a slot machine with each row spinning
# independantly and stopping on a independant image.
# No additional libraries required, just uses displayio.
# Image fruit.bmp should be in CIRCUITPY images directory.
...
# RGB matrix display.
bitmap_file = open("images/fruit.bmp", 'rb')
